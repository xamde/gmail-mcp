...
To use the local IMAP repository, you need to create an instance of the `de.xam.vibe.gmailmcp.repository.LocalEmailRepository` class, providing the paths to the file repository and the search index.
